...
def convert_lcia_methods_data(dir_methods:str=None, version_methods:str=None):
    # csv_file = csv.reader(
    ...
    # ]
    csv_data = None
    if dir_methods is None:
        dir_methods=dirpath
        filename = "LCIA_Implementation_3.9.xlsx"
    else:
        filename = f"LCIA Implementation {version_methods}.xlsx"
    
    sheet = get_sheet(os.path.join(dir_methods,filename), "CFs")
    ...
    sheet = get_sheet(os.path.join(dir_methods, filename), "Indicators")
